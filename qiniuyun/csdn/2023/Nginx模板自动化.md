...
categories:
- Nginx
date: 2023-04-10 14:29:25
description: 背景在日常工作中，我们经常需要创建配置文件的模板，以便在不同的环境中快速部署和配置服务器。然而，这样的任务通常需要重复性高、耗时长，且容易出错。为了加快这些任务的完成，并提高工作效率，可以使用一些自动。。。。。。。
...
![在这里插入图片描述](../../image/a7b17f5b94b34c36a5a59113f68438c1.png)
...
```
![在这里插入图片描述](../../image/4133ca74f16e49aea444f688035065a2.png)
