...
description: 为什么要写这个邮件告警接口？？？？？？因为日常范围，我们在操作系统上，需要报警时，只能采用来使用。需要配置账号，密码，和邮箱认证。如果需要多台使用的话，岂不是很麻烦，要配置多台，这个导致密码很不安全，。。。。。。。
...
![](http://image.ownit.top/csdn/f82790457251415f8f747422b0c2549f.png)

![](http://image.ownit.top/csdn/a592ffe3fae24e92a4309fe0f1fca608.png)** 调用方式（已做脱敏）**
