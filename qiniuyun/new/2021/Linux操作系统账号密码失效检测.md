...
description: 根据我开发的邮件接口上调用操作，触发告警的编程实现邮件接口报警的编程实现邮件接口报警编写邮件接口支持多人发送编写邮件接口支持多人发送编写邮件告警接口添加优化日志记录首先，我们操作系统可以创建多个用户账。。。。。。。
...
![](http://image.ownit.top/csdn/d033a1bbe8474b1790781dab2229b3d7.png)

 ![](http://image.ownit.top/csdn/09b90c8dffa044ac84a038006ff5db29.png)

 

![](http://image.ownit.top/csdn/185bd2a62462402ab3b8cb546d81ae45.png)

 ![](http://image.ownit.top/csdn/1ce69121181246b79b2c8ae4140b1a5c.png)