...
description: 因为业务需求，需要连接数据库查询数据数据库类型：，需求：有中连机制，读取配置文件，可实例化，有日志记录配置文件日志类加入日志获取实例指定输出格式文件日志获取当前文件路径控制台日志为添加具体的日志处理器。。。。。。。
...
![](http://image.ownit.top/csdn/e42eaabb593245b2a93aecbc1baac682.png)
