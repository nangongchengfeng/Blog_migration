...
tags=['kubernetes', '监控类', '黑盒测试', 'docker', 'centos']
categories=['Kubernetes', 'Prometheus监控', ' Kubernetes应用']
image = "post/4kdongman/71.jpg"
+++
[作者：南宫乘风   原文链接:https://blog.csdn.net/heian_99/article/details/114984598](https://blog.csdn.net/heian_99/article/details/114984598)
...
github文档：[https://github.com/prometheus/blackbox_exporter](https://github.com/prometheus/blackbox_exporter)
