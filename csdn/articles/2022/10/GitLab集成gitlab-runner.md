...
+++
[作者：南宫乘风   原文链接:https://blog.csdn.net/heian_99/article/details/127610131](https://blog.csdn.net/heian_99/article/details/127610131)
...
## 特点
<li> **允许运行：** 
  <ul>-  **同时执行多个作业。** -  **对多个服务器（甚至每个项目）使用多个令牌。** -  **限制每个令牌的并行作业数。** 
**可以运行作业：**
-  **在本地。** -  **使用Docker容器。** -  **使用Docker容器并通过SSH执行作业。** -  **使用Docker容器在不同的云和虚拟化管理程序上自动缩放。** -  **连接到远程SSH服务器。** 
...
## 1. 使用GItLab官方仓库安装
-  **重点掌握CentOS系统的安装方式** -  **重点掌握Ubuntu系统的安装方式** 
...
**下载软件包**
1.  **在**​[https://gitlab-runner-downloads.s3.amazonaws.com/latest/index.html上](https://gitlab-runner-downloads.s3.amazonaws.com/latest/index.html)找到最新的文件名和选项 。 1.  **选择一个版本并下载二进制文件，如文档所述，该文件用于**​[下载任何其他标记的](https://docs.gitlab.com/12.6/runner/install/bleeding-edge.html#download-any-other-tagged-release) GitLab Runner发行版。 
例如，对于Debian或Ubuntu：
...
![5d6c25f9f0614c63a3438c2734ddcf7e.png](https://img-blog.csdnimg.cn/5d6c25f9f0614c63a3438c2734ddcf7e.png)
...
**参考链接：**​[使用GitLab CI运行GitLab Runner并执行Pipeline](https://help.aliyun.com/document_detail/106968.html#title-xfl-dp6-kta)

**大概过程： 获取runner token -&gt; 进行注册**

## GitLabRunner 类型
-  **shared ： 运行整个平台项目的作业（gitlab）** -  **group： 运行特定group下的所有项目的作业（group）** -  **specific: 运行指定的项目作业（project）** -  **locked： 无法运行项目作业 ** -  **paused： 不会运行作业** 
## 获取runner token
...
![28eb9f30fb9143aaaa4556fb6007427d.png](https://img-blog.csdnimg.cn/28eb9f30fb9143aaaa4556fb6007427d.png)
...
![860757647b324183bd637ac38a065a62.png](https://img-blog.csdnimg.cn/860757647b324183bd637ac38a065a62.png)
...
![48e3b6ff4d9b40a39cda82d98a9a33a2.png](https://img-blog.csdnimg.cn/48e3b6ff4d9b40a39cda82d98a9a33a2.png)
...
![b269b4bfdc6d4c4e850c934b446dcb18.png](https://img-blog.csdnimg.cn/b269b4bfdc6d4c4e850c934b446dcb18.png)
...
![bae8bdaac3e543f29599f932ce789448.png](https://img-blog.csdnimg.cn/bae8bdaac3e543f29599f932ce789448.png)
